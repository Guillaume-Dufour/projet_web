module.exports = {
    ...
    inscription_post: function (req, res) {
        ...
        if (data.password_utilisateur.length >= 8) {
            ...
            errors.password = "Taille du mot de passe saisi insuffisante";
        }

        if (data.telephone_utilisateur.charAt(0) !== '0' || data.telephone_utilisateur.length > 10) {
            errors.telephone = "Saisie du numéro de téléphone invalide"
        }
        ...
        var estVide = (errors === undefined)
        console.log(errors)
        console.log("Taille de erreur : "+estVide);
